...
public class OutputMessages {
    ...
    public static final String CHILD_INSERT_MESSAGE = "Please type the child's id ,the  name you want to insert and the city where the person is born";
    ...
    public static final String INSERT_FATHER_REQUIREMENTS_MESSAGE = ("Please type the id which corresponds to the child's ID\"" +
            ", name and the city you want to insert,");
    ...
    public static final String INSERT_MOTHER_REQUIREMENTS_MESSAGE = ("Please type the id which corresponds to the child's ID\"" +
            ", name and the city you want to insert,");
